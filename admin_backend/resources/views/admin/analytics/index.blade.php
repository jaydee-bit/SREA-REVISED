...
<script>
    ...
    const responderMarkers = {}; // responder_id -> Leaflet marker, so live updates can find the right pin
    ...
    // --- Real-time: listen for new incidents and responder location updates via Reverb/Echo ---
    if (window.Echo) {
